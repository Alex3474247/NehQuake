...
cvar_t  gl_ztrick = {"ztrick","0"}; // Nehahra: Renamed to prevent change
...
qboolean VID_SetWindowedMode (int modenum)
{
	...
	modestate = MS_WINDOWED;
        // Nehahra - Yes, Havoc was right. this is a VERY bad idea :)
        //           I'll be nice and assume it was a winquake left-over..
        /*
...
#ifdef _WIN32
// Nehahra - ARB
// Favour ARB_multitexture over SGIS_multitexture
